...
function PaginationPrevious({
    ...
    return (
        <PaginationLink aria-label="Önceki sayfaya git" size="default" className={cn("pl-2!", className)} {...props}>
...
function PaginationNext({
    ...
    return (
        <PaginationLink aria-label="Sonraki sayfaya git" size="default" className={cn("pr-2!", className)} {...props}>
            <span className="hidden sm:block">{text}</span>
