        ...
        <div className="w-full max-w-md">
            <div className="border rounded-xl bg-card shadow-sm overflow-hidden text-center space-y-6">
                ...
                <div className="bg-destructive/10 border-b border-destructive/20 p-8 flex flex-col items-center justify-center">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight text-foreground">Yetkisiz Erişim</h1>
                </div>

                {/* Content Section */}
                <div className="p-8 pt-2 space-y-6">
                    <p className="text-muted-foreground text-sm leading-relaxed">
                        Yönetici panelinden hesabınız silinmiş veya admin yetkileriniz kaldırılmıştır. Güvenlik
                        nedeniyle oturumunuz iptal edildi.
                    </p>
