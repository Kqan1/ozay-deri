...
import { Package, Folders, Settings2, Activity, ArrowUpRight, Plus } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";

export default function AdminDashboardPage() {
    const { data: session } = useSession();
    const [stats, setStats] = useState({ productsCount: 0, categoriesCount: 0, fieldsCount: 0 });
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Hoş geldiniz, <span className="font-semibold text-foreground">{session?.user?.name || "Yönetici"}</span>. Sisteminizin güncel durumu aşağıdadır.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="h-[400px] flex flex-col">
                    ...
                    <CardContent className="flex-1 flex flex-col gap-3">
                        <Link href="/admin/products" className="group flex items-center justify-between p-4 rounded-lg border bg-background hover:bg-accent transition-colors">
                        ...
                        <Link href="/admin/categories" className="group flex items-center justify-between p-4 rounded-lg border bg-background hover:bg-accent transition-colors">
                            <div className="flex items-center gap-3">
                        ...
                        <Link href="/admin/fields" className="group flex items-center justify-between p-4 rounded-lg border bg-background hover:bg-accent transition-colors">
                            <div className="flex items-center gap-3">
